            ...
            <div class="col-xl-10 col-lg-12">
              ...
              <div class="card">
                <div class="card-header border-bottom">
                  <!-- Wizard navigation-->
                  <div class="nav nav-pills nav-justified flex-column flex-xl-row nav-wizard" id="productWizardTab"
                    role="tablist">
                    <!-- Wizard navigation item 1-->
                    <a class="nav-item nav-link active" id="step1-tab" href="#step1" data-bs-toggle="tab" role="tab"
                          ...
                          <div class="col-xxl-9 col-xl-10">
                            ...
                            <div class="mb-3">
                              <label class="small mb-1" for="inputProductName">Product
                                Name</label>
                              <input class="form-control" id="inputProductName" name="product_name" type="text"
                                placeholder="e.g. Wireless Mechanical Keyboard" minlength="10" maxlength="150" required  />
                            </div>

                            <div class="mb-3">
                              <label class="small mb-1" for="inputShortDescription">Short
                                Description</label>
                              <input class="form-control" id="inputShortDescription" name="short_description"
                                type="text" minlength="30" maxlength="170" required
                            ...
                            <div class="mb-3">
                              <label class="small mb-1" for="inputFullDescription">Full
                                Description</label>
                              <textarea class="form-control" id="inputFullDescription" name="full_description" rows="5"
                            ...
                            <div class="row gx-3">
                              ...
                              <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" id="inputBrand" name="brand" type="text"
                            ...
                            <div class="mb-3">
                              ...
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" id="statusActive" name="status" type="radio"
                                  value="active" checked />
                                <label class="form-check-label" for="statusActive">Active</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" id="statusInactive" name="status" type="radio"
                                  value="inactive" />
                            ...
                            <div class="row gx-3">
                              <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group">
                                  ...
                                  <input class="form-control" id="inputCostPrice" name="cost_price" type="number"
                              ...
                              <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group">
                                  <span class="input-group-text">$</span>
                                  <input class="form-control" id="inputSellingPrice" name="selling_price" type="number"
                                    min="0" step="0.01" placeholder="0.00" required />
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="row gx-3">
                              <div class="mb-3 col-md-6">
                                ...
                                <select class="form-select" id="selectDiscountType" name="discount_type">
                                  ...
                                  <option value="relative">Percentage (%)</option>
                                  <option value="fixed">Fixed Amount</option>
                                </select>
                              </div>
                              <div class="mb-3 col-md-6">
                                <label class="small mb-1" for="inputDiscountValue">Discount Value</label>
                                <input class="form-control" id="inputDiscountValue" name="discount_value" type="number"
                            ...
                            <div class="row gx-3">
                              <div class="mb-3 col-md-6">
                                <label class="small mb-1" for="inputStockQuantity">Stock
                                  Quantity</label>
                                <input class="form-control" id="inputStockQuantity" name="stock_quantity" type="number"
                                  min="0" step="1" placeholder="0" required />
                              </div>
                              <div class="mb-3 col-md-6">
                                <label class="small mb-1" for="inputLowStockThreshold">Low Stock Alert
                                  Threshold</label>
                                <input class="form-control" id="inputLowStockThreshold" name="low_stock_threshold"
                                  type="number" min="0" step="1" placeholder="e.g. 5" />
                          ...
                          <div class="col-xxl-9 col-xl-10">
                            ...
                            <div class="mb-3">
                              <label class="small mb-1" for="inputImageGallery">Image
                                Gallery</label>
                              <input class="form-control" id="inputImageGallery" name="gallery_images[]" type="file"
...
<script src="<?= Asset::url('js/shared/validation.js')?>"></script>
<script src="<?= Asset::url('js/shared/wizard.js')?>"></script>
<script src="<?= Asset::url('js/shared/discount.js')?>"></script>
<script src="<?= Asset::url('js/shared/constraints.js')?>"></script>
<script src="<?= Asset::url('js/shared/scroll.js')?>"></script>
<script src="<?= Asset::url('js/shared/dom.js')?>"></script>

<script src="<?= Asset::url('js/pages/add-product.js')?>"></script>  <script>
